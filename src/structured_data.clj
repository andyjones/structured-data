...
; TODO: difference between apply and map?
(defn authors [books]
...
(defn count-books [books]
  (let [n-books (count books)]
    (cond (= n-books 0) "No books."
          (= n-books 1) "1 book."
          :else         (str n-books " books."))))

(defn books->string [books]
  (let [books-str (map (fn [x] (str x ".")) (map book->string books))]
    (apply str (interpose " " (cons (count-books books) books-str)))))
